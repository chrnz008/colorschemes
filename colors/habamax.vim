...
let g:terminal_ansi_colors = ['#1c1c1c', '#af5f5f', '#87af87', '#af875f', '#5f87af', '#af87af', '#5f8787', '#c7c7c7', '#767676', '#d75f87', '#87d787', '#d7af87', '#5fafd7', '#d787d7', '#87afaf', '#eeeeee']
...
hi Character guifg=#87af87 guibg=NONE guisp=NONE gui=NONE ctermfg=108 ctermbg=NONE cterm=NONE term=NONE
...
hi Cursor guifg=#1c1c1c guibg=#eeeeee guisp=NONE gui=NONE ctermfg=234 ctermbg=255 cterm=NONE term=reverse
...
hi CursorLineNr guifg=#eeeeee guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold
...
hi MoreMsg guifg=#87af87 guibg=NONE guisp=NONE gui=NONE ctermfg=108 ctermbg=NONE cterm=NONE term=NONE
...
hi PmenuExtra guifg=#767676 guibg=#3a3a3a guisp=NONE gui=NONE ctermfg=243 ctermbg=237 cterm=NONE term=reverse
...
hi PmenuMatch guifg=#eeeeee guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold
hi PmenuMatchSel guifg=#eeeeee guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold
hi PmenuSbar guifg=NONE guibg=#444444 guisp=NONE gui=NONE ctermfg=NONE ctermbg=238 cterm=NONE term=reverse
...
hi PmenuThumb guifg=NONE guibg=#8a8a8a guisp=NONE gui=NONE ctermfg=NONE ctermbg=245 cterm=NONE term=NONE
...
hi QuickFixLine guifg=NONE guibg=#4f2f4f guisp=NONE gui=NONE ctermfg=255 ctermbg=53 cterm=NONE term=NONE
...
hi TitleBar guifg=#eeeeee guibg=#3c3c3c guisp=NONE gui=NONE ctermfg=255 ctermbg=237 cterm=NONE term=NONE
hi TitleBarNC guifg=#767676 guibg=#2c2c2c guisp=NONE gui=NONE ctermfg=243 ctermbg=236 cterm=NONE term=NONE
hi Todo guifg=#eeeeee guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold,reverse
...
hi htmlH1 guifg=#eeeeee guibg=NONE guisp=NONE gui=bold ctermfg=255 ctermbg=NONE cterm=bold term=bold
...
if s:t_Co >= 16
  ...
  hi PmenuBorder ctermfg=black ctermbg=gray cterm=NONE
  hi PmenuExtra ctermfg=black ctermbg=gray cterm=NONE
  hi PmenuExtraSel ctermfg=gray ctermbg=black cterm=NONE
  hi PmenuKind ctermfg=gray ctermbg=black cterm=NONE
  hi PmenuKindSel ctermfg=NONE ctermbg=NONE cterm=NONE
  hi PmenuMatch ctermfg=black ctermbg=gray cterm=bold
  hi PmenuMatchSel ctermfg=gray ctermbg=black cterm=bold
